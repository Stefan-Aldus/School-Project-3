  ...
  <main class="bg">
    <section class="about-h">
      <div class="about-title-h">
        ...
        <p>Wij zijn BrouwersKazen. BrouwersKazen is een klein bedrijf dat gevestigd is in Spijkenisse in eind 2022 tijdens de start van project 3 door
          4 studenten van het TCR MBO college die samen besloten te werken: Jens Brouwershaven, Jesse van Vliet, Stefan Aldus en Rowen Bakkeren. Ons
