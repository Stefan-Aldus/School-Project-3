  ...
  <main class="bg">
    <div class="about-mk">
      <div class="about-mk-title">
        <h1>Product klacht</h1>
        <p>Heeft u een klacht over een product omdat het product niet aan uw verwachtingen voldeet, of vind u dat het
          product het niet naar toebehoren doet?
          Dien dan hier een klacht in en u zult binnen 24 uur gegaradeerd een antwoord terug ontvangen.
        </p>



      </div>
      <img class="about-mk-pic" src="img/productklacht.png" alt="">
    </div>
